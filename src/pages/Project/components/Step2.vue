...
单位信息
 ...
 <el-form-item label="标题属性">
       ...
       <el-form-item label="单位全称">
        ...
        <el-form-item label="单位简称" prop="name3">
        <el-input v-model="ruleForm.name3" placeholder="请输入公司简称（必填）"></el-input>
      </el-form-item>
 ...
 <el-select v-model="ruleForm.value11" 
 :multiple="false" 
 filterable
  allow-create 
  ...
  <div class="speLabelUlBox">
          <el-option v-for="item in ruleForm.options6" :key="item.value" :label="item.label" :value="item.value" class="speLabelLists">
      ...
      <!-- <span style="float: right; color: #8492a6; font-size: 13px">{{ item.value }}</span> -->
        ...
        <!-- <el-input v-model="ruleForm.name2" placeholder="请输入"></el-input> -->
...
<div class="stepH1InfoRigth"  @click="addDomain"><span class="iconfont addproIcon">&#xe659;</span>新增部门</div>
...
<script>
import { character } from "../../../assets/lib/myStorage.js";
